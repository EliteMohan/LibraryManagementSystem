...
import android.com.mohan.Modules.UserModule.FragmentEmailComponents.FragmentBookRecommend;
import android.com.mohan.Modules.UserModule.FragmentEmailComponents.FragmentFeedbackBook;
...
//        TextView search = view.findViewById(R.id.search_bookID);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentRecyclerViewAllBooks viewAllBooks = new FragmentRecyclerViewAllBooks();
