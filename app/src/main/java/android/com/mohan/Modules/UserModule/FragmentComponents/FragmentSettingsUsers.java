...
import android.com.mohan.Modules.AuthenticationModule.ActivityComponents.AuthenticationActivity;
import android.com.mohan.Modules.CommonModule.FragmentComponents.FragmentAboutUsPage;
import android.com.mohan.Modules.CommonModule.FragmentEmailComponents.FragmentEmailFeedback;
...
public class FragmentSettingsUsers extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_settings_users, container, false);
        ...
        aboutus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                assert getFragmentManager() != null;
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.fragment_container, aboutUsPage);
                transaction.addToBackStack(null);
                transaction.commit();
            }
        });
