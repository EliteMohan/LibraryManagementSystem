...
import android.com.mohan.Modules.CommonModule.FragmentDialogComponents.ViewBookDialog;
...
public class BookListAdapter extends FirestoreRecyclerAdapter<BooksModel, BookListAdapter.ViewHolder> {
    ...
    public BookListAdapter(@NonNull FirestoreRecyclerOptions<BooksModel> options, Context context, String tag, ContentLoadingProgressBar progressBar) {
        super(options);
