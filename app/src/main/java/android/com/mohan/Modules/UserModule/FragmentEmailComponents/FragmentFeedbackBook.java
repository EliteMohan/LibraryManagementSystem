package android.com.mohan.Modules.UserModule.FragmentEmailComponents;
...
public class FragmentFeedbackBook extends Fragment {
    private EditText Message;
    private TextView Subject, toMail;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.feedback_about_book, container, false);
        //Textview
