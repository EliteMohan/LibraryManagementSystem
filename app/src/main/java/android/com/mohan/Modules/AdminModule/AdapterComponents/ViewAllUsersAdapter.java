package android.com.mohan.Modules.AdminModule.AdapterComponents;

import android.com.mohan.Models.UsersModel;
import android.com.mohan.Modules.AdminModule.FragmentDialogComponents.ViewUserDialog;
...
public class ViewAllUsersAdapter extends FirestoreRecyclerAdapter<UsersModel,ViewAllUsersAdapter.ViewHolder> {
    ...
    public ViewAllUsersAdapter(@NonNull FirestoreRecyclerOptions<UsersModel> options, Context aContext, ContentLoadingProgressBar progressBar) {
        super(options);
